...
const checkValidatorResult = ({ resource, msg }) => (req, res, next) => {
        ...
        for (const valError of errors) {
            if (valError.type == "field") {
                ...
                if (valError.path == "title") {
                    ...
                    return res.status(400).send(apiError !== null && apiError !== void 0 ? apiError : { id: 9 });
                }
                if (valError.path == "content") {
                    return res.status(400).send({
                        id: 104,
                        message: "Content of short has to be between 10 and 500 characters",
                    });
                }
