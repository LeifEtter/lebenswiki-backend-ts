...
const createCommentForShort = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return (0, helper_error_1.handleError)({ res, rName: "Short", rId: res.locals.id, error });
    }
});
...
const createCommentForPack = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return (0, helper_error_1.handleError)({ res, rName: "Pack", rId: res.locals.id, error });
    }
});
...
const downvoteComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return (0, helper_error_1.handleError)({ rName: "Comment", rId: res.locals.id, res, error });
    }
});
