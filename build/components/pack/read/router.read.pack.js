...
router.route("/create/:id").post(validation_middleware_1.checkValidId, authentication_middleware_1.default, (0, express_validator_1.body)("progress").exists().isNumeric(), (0, validation_middleware_1.checkValidatorResult)({
    msg: "Please make sure to pass 'progress' with an integer",
