...
exports.uploadPackImage = exports.clapForPack = exports.getAllPacksWithCategories = exports.getAllPacks = exports.deleteOwnPack = exports.unpublishPack = exports.publishPack = exports.getUnreadPacks = exports.getReadPacks = exports.getOwnPublished = exports.getOwnUnpublished = exports.viewPack = exports.createPack = exports.updatePack = void 0;
...
const updatePack = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if ((prevPack === null || prevPack === void 0 ? void 0 : prevPack.creatorId) != res.locals.user.id) {
            return res
                .status(401)
        ...
        const pack = yield database_1.default.pack.update({
            ...
            data: {
                ...
                Category: {
                    ...
                    connect: req.body.categories.map((cat) => cat),
                },
            },
            include: {
                Category: true,
...
const createPack = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const packsForResponse = yield (0, helpers_pack_1.getPacksForReturn)({
            where: {
                id: packResult.id,
            },
...
const uploadPackImage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, controller_image_1.uploadImageToS3)(`packs/${res.locals.id}/cover.png`, req.file.buffer);
        const url = yield (0, controller_image_1.getSignedUrlForCover)(res.locals.id);
...
exports.uploadPackImage = uploadPackImage;
