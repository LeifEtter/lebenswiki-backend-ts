...
router.route("/create/:id").post(validation_middleware_1.checkValidId, authentication_middleware_1.default, (0, express_validator_1.body)("reason").exists().isString().escape(), (0, validation_middleware_1.checkValidatorResult)({
    resource: "Report",
